...
class XAudioServer {
	...
	failureCallback: any;
	samplesAlreadyWritten: any;
	audioHandleMoz: any;
	audioType: any;
	audioHandleMediaStream: HTMLAudioElement;
	audioHandleMediaStreamProcessing: any;
	flashInitialized: boolean;
	audioHandleFlash: any;
	...
	*/
	...
	initializeFlashAudio() {
		...
		if (existingFlashload == null) {
			...
			(window as any).swfobject.embedSWF(
...
var XAudioJSWebAudioWatchDogLast = 0;
var XAudioJSWebAudioLaunchedContext = false;
var XAudioJSAudioContextSampleBuffer: any[] | Float32Array = [];
var XAudioJSResampledBuffer: any[] | Float32Array = [];
...
var XAudioJSMediaStreamBuffer = new Float32Array(1);
